        ...
        authAccountStr += `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            ...
            <div class="settingsAuthAccountRight">
                ...
                <div class="settingsAuthAccountActions">
                    <button class="settingsAuthAccountSelect" ${selectedUUID === acc.uuid ? 'selected>Sélection de Compte &#10004;' : '>Select Account'}</button>
        ...
        v.onclick = () => {
            ...
            if(res){
                ...
                setOverlayContent(
                    ...
                    'Assurez-vous que le fichier est pas utilisé et réessayez. ',
                    'Ok'
                )
        ...
        if(dropinUI != null){
            ...
            if(DropinModUtil.isDropinModEnabled(dropin.fullName) != dropinUIEnabled){
                DropinModUtil.toggleDropinMod(CACHE_SETTINGS_MODS_DIR, dropin.fullName, dropinUIEnabled).catch(err => {
                    if(!isOverlayVisible()){
                        setOverlayContent(
                            'Échec du basculement<br>One or More Drop-in Mods',
                            err.message,
                            'Ok'
                        )
                        setOverlayHandler(null)
